...
public class Operacion {
    ...
    public static final String DISCOVERY_REQUEST_SLAVE = "DISCOVERY_REQUEST_SLAVE";
    public static final String DISCOVERY_RESPONSE_SLAVE = "DISCOVERY_RESPONSE_SLAVE";
